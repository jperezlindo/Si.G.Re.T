        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="/menus/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="/menus/img/user2-160x160.jpg" class="user-image" alt="User Image">
...
<!-- AdminLTE App -->
<script src="/menus/js/app.min.js"></script>
