...
@section('content')
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1">
      <div class="alert alert-info text-center" role="alert">
        <h5><strong>Agregar/Quitar Categorias</strong>, aqui puede agregar o quitar las categorias que podran participar en el torneo.</h5 class="text center">
      </div>
      <hr>
    </div>
  </div>
    ...
    <form class="form-group" method="POST" action="{{ route('torneo.store_cat') }}">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1">
          ...
          <textarea class="form-control" rows="3" name="descripcion"  maxlength="250" required></textarea>
        </div>
      </div>
      <br>
      <div class="row">
        ...
        <table class="table table-hover">
          ...
          @foreach ($agregadas as $categoria)
            <tr>
              ...
              <td class = "success text-center" title="EDITAR">
                <a href="{{route('torneo.editar_cat', $categoria->id)}}" class="btn btn-warning btn-xs">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-6 col-md-2 col-md-offset-1">
      <div class="form-group">
        <a  href="{{ route('torneo.edit', $torneo->id) }}" class="btn btn-warning btn-block"><b>SALIR</b></a>
      </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-2 col-md-offset-6">
      <div class="form-group">
        <a  href="{{ route('torneo.index') }}" 	class="btn btn-success btn-block"><b>FINALIZAR</b></a>
      </div>
    </div>
  </div>
