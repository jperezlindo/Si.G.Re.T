...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
    <div class="alert alert-info text-center" role="alert">
      <h3><strong>CANTIDAD DE RESERVAS POR DIAS</strong></h3>
      SELECCIONE LAS FECHAS DESDE Y HASTA, Y PRESIONE EN EL BOTON CONSULTAR. EL SISTEMA MOSTRARA LA CANTIDAD DE RESERVAS QUE HICIERON EN CADA UNO DE LOS DIAS DE LA SEMANA.
    </div>
  </div>
</div>

<form class="form-group" method="GET" action="{{ route('informe.get_crdf')}}">
  <div class="row">
...
@if(!empty($dias))
  @include('informes.reservas.reservas_dias_grafico')
@endif
<hr>
<div class="row">
