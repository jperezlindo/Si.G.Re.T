...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
    <div class="alert alert-info text-center" role="alert">
      <h3><strong>SERVICIOS MAS OCUPADOS</strong></h3>
      SELECCIONE LAS FECHAS DESDE Y HASTA, Y PRESIONE EN EL BOTON CONSULTAR. EL SISTEMA LE ARROJARA UN GRAFICO MOSTRANDOLE EL PORSENTAJE Y CANTIDAD DE LOS SERVICIOS MAS CONTRATADOS.
    </div>
  </div>
</div>

<form class="form-group" method="GET" action="{{ route('informe.get_cso')}}">
  <div class="row">
...
@if (!empty($servicios))
  @include('informes.servicios.servicios_ocupados_grafico')
@endif
